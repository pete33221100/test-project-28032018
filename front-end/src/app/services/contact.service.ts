...
export class ContactService {
    ...
    getContacts(keyWord: string, tagId: number, itemsPerPage: number, pageNo: number): Observable<ContactList> {
        const url = `${Constants.apiContacts}?keyWord=${keyWord}&tagId=${tagId}&itemsPerPage=${itemsPerPage}&pageNo=${pageNo}`;
